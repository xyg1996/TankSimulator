...
class Maincontrol(Q.QWidget):
    ...
    def showreact(self):
            ...
            if sender == self.bt4:
                ...
                # self.tempprocess.setWorkingDirectory(os.path.dirname(os.path.abspath(__file__)))
                #os.system("./WordShell")
                self.tempprocess.start("/share/simforge_share/open-source/Tanksimulator/Tanksimulator/SALOME-9.4.0-CO7-SRC/BINARIES-CO7/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/hexinjisuan/WordShell "+self.currentpath) #&& /usr/bin/libreoffice demo.docx")
